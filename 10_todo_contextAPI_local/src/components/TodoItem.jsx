...
function TodoItem({ todo }) {
	...
	const { deleteTodo, toggleIsChecked, updateTodo } = useTodo();
	...
	return (
		<div
			...
			{/* Edit, Save Button */}
			<button
				className='inline-flex w-8 h-8 rounded-lg text-sm border border-black/10 justify-center items-center bg-gray-50 hover:bg-gray-100 shrink-0 cursor-pointer disabled:opacity-50'
				onClick={() => {
